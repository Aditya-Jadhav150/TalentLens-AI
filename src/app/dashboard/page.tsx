      ...
      <div className="max-w-6xl w-full mx-auto animate-fade-in-up">
        <div className="flex justify-between items-center mb-10">
          <div>
            ...
            <p className="text-slate-500 text-sm">Manage your candidate interviews and evaluations.</p>
          </div>
          <Link href="/apply" className="px-5 py-2.5 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors shadow-sm text-sm">
            New Interview
          </Link>
        </div>

        <div className="bg-white rounded-xl p-10 border border-slate-200 shadow-sm min-h-[400px] flex flex-col items-center justify-center text-center">
